  ...
  <main class="sm:px-0 pb-[60px] pt-12 sm:pt-16 md:pt-0">
    <div class="max-w-screen-2xl mx-auto sm:px-4 flex pb-5">
      <div class="flex gap-5 w-full relative">
        ...
        >
          <div class="text-2xl font-bold">{{ subSubCategory.title }}</div>
                    ...
                    <p
                      ...
                      :class="[
                        item.name == queryName
                          ...
                          : '',
                        'px-3 py-1 w-full hover:bg-gray-100 text-gray-500 hover:text-gray-900 md:cursor-pointer',
                      ]"
                    >
                      {{ item.name }}
                    </p>
...
const pages = [{ name: "Sub Child Category", href: "#", current: false }];
