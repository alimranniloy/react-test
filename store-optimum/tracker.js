                ...
                var y = (function e(t) {
                    ...
                    return m(e, function (e, n) {
                      ...
                      return (
                        !e &&
                          ...
                          ((e = String(
                            n.label && !RegExp(r, "i").test(n.label)
                              ? n.label
                              : e
                          ).split("/"))[1] &&
                            !/[\d.]+/.test(e[0]) &&
                  ...
                  if (
                    ...
                    /\bAndroid\b/.test(K) &&
                      ...
                      (X =
                        x(l[1]).replace(/^[a-z]{2}-[a-z]{2};\s*/i, "") || null),
                    D && !X
                      ? (X = L([D]))
                      : D &&
                        X &&
                    ...
                    "Opera Mini" == N &&
                      /\bOPiOS\b/.test(t) &&
                      $.push("running in Turbo/Uncompressed mode"),
                    "IE" == N && /\blike iPhone OS\b/.test(t)
                      ? ((D = (l = e(t.replace(/like iPhone OS/, "")))
                          .manufacturer),
                        (X = l.product))
                      : /^iP/.test(X)
                      ? (N || (N = "Safari"),
                      ...
                      : "Silk" == N
                      ? (/\bMobi/i.test(t) ||
                          ((K = "Android"), $.unshift("desktop mode")),
                        /Accelerated *= *true/i.test(t) &&
                          $.unshift("accelerated"))
                      : "UC Browser" == N && /\bUCWEB\b/.test(t)
                      ? $.push("speed mode")
                      : "PaleMoon" == N && (l = /\bFirefox\/([\d.]+)\b/.exec(t))
                      ? $.push("identifying as Firefox " + l[1])
                      : "Firefox" == N &&
                        (l = /\b(Mobile|Tablet|TV)\b/i.exec(t))
                      ? (K || (K = "Firefox OS"), X || (X = l[1]))
                      : !N ||
                        (l =
                    ...
                    if (
                      ...
                      g((l = n.runtime)) == w
                        ? ((N = "Adobe AIR"),
                          (K = l.flash.system.Capabilities.os))
                        : g((l = n.phantom)) == M
                        ? ((N = "PhantomJS"),
                          (j =
                            (l = l.version || null) &&
                        ...
                        ? ((j = [j, k.documentMode]),
                          (l = +l[1] + 4) != j[1] &&
                            ...
                            G && (G[1] = ""),
                            (j[1] = l)),
                          (j = "IE" == N ? String(j[1].toFixed(1)) : j[0]))
                        : "number" == typeof k.documentMode &&
                      ...
                      (P &&
                        ((W = (l = P.lang.System).getProperty("os.arch")),
                        (K =
                          K ||
                      ...
                      try {
                        ...
                        (l = n.system) &&
                          l.global.system == n.system &&
                          ((N = "Narwhal"), K || (K = l[0].os || null));
                      }
                      N || (N = "Rhino");
                    } else
                      "object" == typeof n.process &&
                        ...
                        ("object" == typeof l.versions &&
                          ("string" == typeof l.versions.electron
                            ? ($.push("Node " + l.versions.node),
                              (N = "Electron"),
                              (j = l.versions.electron))
                  ...
                  if (
                    (j &&
                      (l =
                        ...
                        /(?:alpha|beta)(?: ?\d)?/i.exec(
                          t + ";" + (F && o.appMinorVersion)
                        ) ||
                        (/\bMinefield\b/i.test(t) && "a")) &&
                      ((T = /b/i.test(l) ? "beta" : "alpha"),
                      (j =
                        j.replace(RegExp(l + "\\+?$"), "") +
                        ("beta" == T ? C : A) +
                        (/\d+\+?/.exec(l) || ""))),
                    "Fennec" == N ||
                      ("Firefox" == N &&
                        /\b(?:Android|Firefox OS|KaiOS)\b/.test(K)))
                  )
                    N = "Firefox Mobile";
                    ...
                    if ("IE" == N && F)
                      ...
                      (/\bBlackBerry\b/.test(X) || /\bBB10\b/.test(t)) &&
                      (l =
                        (RegExp(
                          X.replace(/ +/g, " *") + "/([.\\d]+)",
                          "i"
                        ...
                        : this != h &&
                          ...
                          ((l =
                            ...
                            ((l = l.version) ? " " + l : "")),
                          u.test(N)
                            ? (/\bIE\b/.test(l) && "Mac OS" == K && (K = null),
                              (l = "identify" + l))
                            : ((l = "mask" + l),
                              (N = B
                                ? f(B.replace(/([a-z])([A-Z])/g, "$1 $2"))
                                : "Opera"),
                              /\bIE\b/.test(l) && (K = null),
                              F || (j = null)),
                          (G = ["Presto"]),
                  ...
                  (l = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(t) || 0)[1]) &&
                      ...
                      (G[1] +=
                        ...
                        (l +=
                          "number" == typeof l
                            ...
                            ? ""
                            : "+")),
                    "Safari" == N && (!j || parseInt(j) > 45)
                      ? (j = l)
                      : "Chrome" == N &&
                        /\bHeadlessChrome/i.test(t) &&
                        $.unshift("headless")),
                    "Opera" == N && (l = /\bzbov|zvav$/.exec(K))
                      ? ((N += " "),
                        $.unshift("desktop mode"),
                        "zvav" == l
                          ? ((N += "Mini"), (j = null))
                          : (N += "Mobile"),
                        (K = K.replace(RegExp(" *" + l + "$"), "")))
                      : "Safari" == N && /\bChrome\b/.exec(G && G[1])
                      ? ($.unshift("desktop mode"),
                        (N = "Chrome Mobile"),
                        (j = null),
                        /\bOS X\b/.test(K)
                          ? ((D = "Apple"), (K = "iOS 4.3+"))
                          : (K = null))
                      : /\bSRWare Iron\b/.test(N) && !j && (j = V("Chrome")),
                    j &&
                      0 == j.indexOf((l = /[\d.]+$/.exec(K))) &&
                      t.indexOf("/" + l + "-") > -1 &&
                      (K = x(K.replace(l, ""))),
                    K &&
                      -1 != K.indexOf(N) &&
                      !RegExp(N + " OS").test(K) &&
                      (K = K.replace(RegExp(" *" + S(N) + " *"), "")),
                    G &&
                    ...
                    (l = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(W)) &&
                    !/\bi686\b/i.test(W)
                      ? (K &&
                          ((K.architecture = 64),
        ...
        function (e, t, n) {
          ...
          var S = function (e, t) {
            ...
            if (
              ...
              return console.warn("Ackee ignores you because you are a bot"), a;
            return {
              record: function (e) {
                var n =
