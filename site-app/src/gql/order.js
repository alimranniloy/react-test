...
`;
// STORE_ORDER_PREVIEW
export const STORE_ORDER_PREVIEW = gql`
...
export const STORE_ORDER_LINE_CHECK_LISTS = gql`
  query ($siteId: Int!, $orders: Int!, $first: Int, $after: String) {
    storeOrderLineCheckLists(
      siteId: $siteId
      orders: $orders
      first: $first
      after: $after
  ...
  mutation selfStoreOrderUpdate(
    ...
    selfStoreOrderUpdate(
      ...
      data: {
        ...
        latitude: $latitude
        logisticsCharge: $logisticsCharge
        logisticsCityId: $logisticsCityId
        logisticsExtraCharge: $logisticsExtraCharge
...
// SELF_STORE_ORDER_LINE_CREATE_BY_SHOP
export const SELF_STORE_ORDER_LINE_CREATE_BY_SHOP = gql`
  mutation selfStoreOrderLineCreateByShop(
    $userId: Int!
    $siteId: Int!
    $orderId: Int!
    $shopId: Int!
    ...
    selfStoreOrderLineCreateByShop(
      userId: $userId
      siteId: $siteId
      orderId: $orderId
      shopId: $shopId
...
`;
// SELF_STORE_ORDER_LINE_UPDATE_BY_SHOP
export const SELF_STORE_ORDER_LINE_UPDATE_BY_SHOP = gql`
  mutation selfStoreOrderLineUpdateByShop(
    $userId: Int!
    $siteId: Int!
    $orderId: Int!
    $shopId: Int!
    ...
    selfStoreOrderLineUpdateByShop(
      userId: $userId
      siteId: $siteId
      orderId: $orderId
      shopId: $shopId
...
// STORE_ORDER_LINE_CREATE_BY_GUEST
export const STORE_ORDER_LINE_CREATE_BY_GUEST = gql`
  mutation storeOrderLineCreateByGuest(
    $otp: Int!
    $siteId: Int!
    $orderId: Int!
    $customerId: Int!
...
`;
// STORE_ORDER_LINE_UPDATE_BY_GUEST
export const STORE_ORDER_LINE_UPDATE_BY_GUEST = gql`
  mutation storeOrderLineUpdateByGuest(
    $otp: Int!
    $siteId: Int!
    $orderId: Int!
    $id: Int!
...
`;
// STORE_ORDER_PAYMENT_PREVIEW
export const STORE_ORDER_PAYMENT_PREVIEW = gql`
  query ($siteId: Int!, $id: Int!) {
...
`;
// STORE_ORDER_REFUND_REQUEST
export const STORE_ORDER_REFUND_REQUEST = gql`
  mutation storeOrderRefundRequest(
    $siteId: Int!
    $orderId: Int!
    $gatewayId: Int!
    $amount: Float!
