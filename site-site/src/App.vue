...
const { site, loading } = storeToRefs(useSiteStore());
if (loading) {
  setLoading(false);
}
</script>
<template>
  <div class="w-full-minus-appbar min-h-screen bg-white">
    <NavBar></NavBar> 
    ...
    <div v-if="loading"
      ...
      <div role="status">
        <svg aria-hidden="true" class="w-8 h-8 mr-2 text-gray-100 animate-spin dark:text-gray-600 fill-blue-600"
