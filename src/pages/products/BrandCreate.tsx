...
import { SELF_STORE_BRAND_CREATE } from "@/graphql/mutations/brand";
...
export default function BrandCreate() {
  ...
  const [createBrand, { loading }] = useMutation(SELF_STORE_BRAND_CREATE);
      ...
      <section className="rounded-2xl bg-white/90 p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">Add a new brand to enrich product discovery.</p>
          </div>
          <button
            type="button"
