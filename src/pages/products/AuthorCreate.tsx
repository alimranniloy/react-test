...
import { SELF_STORE_AUTHOR_CREATE } from "@/graphql/mutations/author";
...
export default function AuthorCreate() {
  ...
  const [createAuthor, { loading }] = useMutation(SELF_STORE_AUTHOR_CREATE);
      ...
      <section className="rounded-2xl bg-white/90 p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">Add an author or creator for attribution.</p>
          </div>
          <button
            type="button"
